...
import 'package:filmfoliov2/widgets/reset_password_dialog.dart';
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextButton(onPressed: openResetPasswordDialog, child: Text('Reset Password Here')),
                        const SizedBox(
                          height: 25,
                        ),
                        ElevatedButton(
                        ...
                        Text(isRegister ? 'or register with' : 'or login with', textAlign: TextAlign.center,),
                        const SizedBox(height: 10),
                        Row(
                          ...
                          children: [
                            ElevatedButton(
                                ...
                                onPressed: AppUser().signInWithGoogle,
                                child: const Text(
                                  'Google',
                                  style: TextStyle(
                                      fontSize: 18,
                            ...
                            ElevatedButton(
                                ...
                                onPressed: AppUser(context: context).signInWithGithub,
                                child: const Text(
                                  'Github',
                                  style: TextStyle(
                                      fontSize: 18,
                            ...
                            //         padding: const EdgeInsets.symmetric(vertical: 18, horizontal: 10)
                            //     ),
                            //     onPressed: AppUser(context: context).signInWithTwitter,
                            //     child: const Text(
                            //       'Twitter',
                            //       style: TextStyle(
                            //           fontSize: 18,
